...
public class Classes {
    ...
    public static Reference<Sol> PatternClass = new Reference(new Sol());
    public static HashMap<Message,SolFunction>
	PatternMethods = new HashMap<Message,SolFunction>(),
	PatternClassMethods = new HashMap<Message,SolFunction>();
	...
	initializeClassEntry(new ClassEntry("Pattern", Pattern, PatternMethods,
					    PatternClass, PatternClassMethods));
    }
}
